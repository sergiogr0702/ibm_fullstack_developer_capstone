...
# todo: finish adding extra fields to data and take screenshots
# first create superuser, npm install and npm run build on frontend and initialize server following instructions 
def initiate():
    car_make_data = [
